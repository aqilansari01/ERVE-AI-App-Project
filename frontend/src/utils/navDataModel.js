...
export const createEmptyNavData = (navQuarter = DEFAULT_NAV_QUARTER) => ({
  ...
  valuationWaterfall: {
    ...
    rows: [
      { label: 'Comparable EV/Rev Multiple', values: ['', '', ''] },
      { label: 'ARR', values: ['', '', ''] },
      { label: 'Enterprise value pre-discount', values: ['', '', ''] },
      { label: 'Discount rate applied to multiple', values: ['', '', ''] },
      { label: 'Enterprise value after discount', values: ['', '', ''] },
      { label: 'Cash', values: ['', '', ''] },
